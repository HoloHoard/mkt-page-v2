  ...
  return (
    <div className="pt-20">
      ...
      <section className="relative bg-gradient-to-br from-[#251433] via-[#1A1A2E] to-[#141F33] py-20 md:py-32 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-br from-[#12D3FF]/20 to-transparent rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          ...
          <div className="text-center space-y-6">
            <div className="inline-block mb-6">
              <div className="px-4 py-2 bg-gradient-to-r from-[#B766FF]/20 to-[#669CFF]/20 border border-[#B766FF]/30 rounded-full">
                <span className="text-[#12D3FF] font-bold text-sm uppercase tracking-wider">All Features</span>
              </div>
            </div>
            <h1 className="text-white text-5xl md:text-6xl lg:text-7xl font-black leading-tight">
              Everything you need to<br />manage your TCG collection
            </h1>
            <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto">
              From tracking individual cards to managing multiple collections across different games,
              HoloHoard has all the features you need to be a serious collector.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: 'View your entire collection at a glance with completion stats and value tracking',
                color: 'cyan'
              },
              {
                icon: '🎴',
                title: 'Card Database',
                description: 'Access over 15,000 cards, parallels, and inserts from multiple TCGs',
                color: 'purple'
              },
              {
                icon: '✨',
                title: 'Parallel Support',
                description: 'Track every variant, from base cards to rare serialised parallels',
                color: 'pink'
              },
              {
                icon: '🏆',
                title: 'Graded Cards',
                description: 'Full support for PSA, BGS, CGC and other grading companies',
                color: 'blue'
              },
              {
                icon: '💰',
                title: 'Price Tracking',
                description: 'Monitor market values and track your collection investment',
                color: 'cyan'
              },
              {
                icon: '🔗',
                title: 'Share Collections',
                description: 'Generate shareable links for trading, selling, or showing off',
                color: 'purple'
              },
              {
                icon: '📝',
                title: 'Custom Notes',
                description: 'Add personal notes, photos, and details to any card',
                color: 'pink'
              },
              {
                icon: '📈',
                title: 'Analytics',
                description: 'Detailed insights into your collecting habits and spending',
                color: 'blue'
              },
              {
                icon: '🎯',
                title: 'Want Lists',
                description: 'Track cards you need and get alerts when prices drop',
                color: 'cyan'
              }
            ].map((feature, index) => (
              <div
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-white text-xl font-bold mb-2 group-hover:text-[#12D3FF] transition-colors">{feature.title}</h3>
      ...
      <section className="relative bg-gradient-to-br from-[#251433] via-[#1A1A2E] to-[#141F33] py-16 md:py-20 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-gray-300 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
            ...
            It's <span className="text-[#12D3FF] font-bold">completely free</span> to get started.
          </p>
